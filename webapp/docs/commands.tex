...
As an example of error reporting, the following input:

\begin{verbatim}
\[ A = \mat{\mat{\silly}{2}{3}{4}}{2}{3}{4} \]
\end{verbatim}

would generate the following error message (if formatted explicitly using
\verb|MessageFormatter| or if your \href[output options]{outputs.html} have
been set apppropriately):
