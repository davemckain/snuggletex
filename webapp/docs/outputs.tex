...
\begin{itemize}
  \item \textbf{MOZILLA} \href[(example)]{math-mode.xhtml}:
  ...
  \item \textbf{MATHPLAYER\_HTML} \href[(example)]{math-mode.html}:
  ...
  \item \textbf{CROSS\_BROWSER\_XHTML} \href[(example)]{math-mode.cxml}:
  ...
  \item \textbf{UNIVERSAL\_STYLESHEET} \href[(example)]{math-mode.xml}:
