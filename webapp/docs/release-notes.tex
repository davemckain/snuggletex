...
\subsection*{Version 1.1 [HEAD] (In Development)}

\begin{itemize}

  \item Migrated to Saxon 9.1.0.5

  \item Renamed internal \verb|DOMBuilderFacade| as \verb|DOMBuildingController|.

  \item Added new \verb|domPostProcessor| property to \verb|DOMOutputOptions| that
    allows you to hook in a class that will post-process the raw DOM produced
    by SnuggleTeX.
  ...
  \item Deprecated the \verb|inferringMathStructure| property from \verb|SnuggleConfiguration|.
    This functionality will be provided (and improved) in the new up-conversion extension.

  \item Up-conversion functionality is currently being worked on as an extension.
  ...
  \item Moved \verb|AbstractWebPageOptions| to top level package and renamed as
    \verb|BaseWebPageOptions|.
