...
\begin{verbatim}java -classpath snuggletex.jar \
uk.ac.ed.ph.snuggletex.extensions.samples.MinimalExample\end{verbatim}

(This assumes that \verb|snuggletex.jar| is in the current directory; you will
of course need to provide a path if it is not.)
