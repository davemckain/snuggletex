...
\href[Web Output Samples]{latex-samples.html} page for details.
...
Note however that the ``legacy web'' view currently renders this with an extraneous close
right parenthesis due to a bug in JEuclid's rendering of the MathML \verb|mfenced| element.} \\
\end{ndemotable}
