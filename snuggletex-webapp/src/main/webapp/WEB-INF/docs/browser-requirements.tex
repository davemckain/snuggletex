...
Pages]{web-page-types.html}, the resulting pages will only be viewable on
...
them, you should consider \href[Creating Legacy Web Pages]{legacy-web-pages.html}.

As you will see on the \href[MathML Web Page Types]{web-page-types.html} page,
