...
(The newline before the \verb|<tt>| in the sample output above has been added to prevent
the text being too wide. You should find that your XML is output as a single line if you
run the example yourself. If you don't like this, you can ask SnuggleTeX to indent the output\ldots)
