...
\begin{enumerate}
  ...
  \item Generate one or more Outputs (either \href[XML/DOM Outputs]{dom-output.html}
  or \href[Web Pages]{web-output.html}).
...
and \href[Creating XML/DOM Outputs]{dom-output.html} or
\href[Creating Web Pages]{web-output.html} to do whatever it is you want to do.
