...
It can also generate \href[Legacy Web Pages]{legacy-web-pages.html} via
...
\item
  ...
  These are listed in the \href[XHTML+MathML Web Page Types]{web-page-types.html}
  page. (You might prefer to create a \href[Legacy Web Page]{legacy-web-pages.html}.)
...
\item
  ...
  \begin{itemize}
    ...
    \item \ldots plus the same options as for generating \href[XML/DOM Outputs]{dom-output.html}.
  \end{itemize}
