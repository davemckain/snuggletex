...
\begin{itemize}
  ...
  \verb|SnuggleTeXEngine| and \verb|SnuggleTeXSession|. Also fixed a bug in the
  application of such options in \verb|SnuggleTeXSession.buildXMLString()|.
...
\begin{itemize}
  ...
  \item Added convenience method to \verb|SnuggleTeXSession| that can create a
