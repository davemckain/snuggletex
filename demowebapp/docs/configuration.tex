...
\item \textbf{Parsing Configuration}: Create a \verb|SessionConfiguration| Objects to control
  aspects of the parsing process. Each \verb|SnuggleTeXSession| can have
  its own configuration, independent of others. You can also set a default
  configuration for a \verb|SnuggleTeXEngine|.
...
\item \textbf{Command Definitions}: SnuggleTeX supports \verb|\newcommand|,
  ...
  programmatically and pass them to your \verb|SnuggleTeXEngine|.
